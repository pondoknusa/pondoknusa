...
export class Blueprint {
  ...
  uuid(name = 'id'): this {
    ...
    switch (this.grammar.driver) {
      ...
      case 'oracle':
        ...
        break;
      case 'mssql':
        this.statements.push(`${column} UNIQUEIDENTIFIER PRIMARY KEY`);
        break;
      default:
  ...
  id(name = 'id'): this {
    ...
    switch (this.grammar.driver) {
      ...
      case 'oracle':
        this.statements.push(
          `${column} NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY`,
        );
        break;
      case 'mssql':
        this.statements.push(`${column} BIGINT IDENTITY(1,1) PRIMARY KEY`);
        break;
      default:
  ...
  string(name: string, length = 255): this {
    ...
    switch (this.grammar.driver) {
      case 'sqlite':
        ...
        break;
      case 'oracle':
        this.statements.push(`${column} VARCHAR2(${length}) NOT NULL`);
        break;
      case 'mssql':
        this.statements.push(`${column} NVARCHAR(${length}) NOT NULL`);
        break;
      default:
  ...
  text(name: string): this {
    ...
    switch (this.grammar.driver) {
      case 'oracle':
        this.statements.push(`${column} CLOB NOT NULL`);
        break;
      case 'mssql':
        this.statements.push(`${column} NVARCHAR(MAX) NOT NULL`);
        break;
      default:
        this.statements.push(`${column} TEXT NOT NULL`);
        break;
  ...
  integer(name: string): this {
    ...
    switch (this.grammar.driver) {
      case 'mysql':
        ...
        break;
      case 'oracle':
        this.statements.push(`${column} NUMBER(10) NOT NULL`);
        break;
      case 'mssql':
        this.statements.push(`${column} INT NOT NULL`);
        break;
  ...
  boolean(name: string): this {
    ...
    switch (this.grammar.driver) {
      ...
      case 'mysql':
        ...
        break;
      case 'oracle':
        this.statements.push(`${column} NUMBER(1) NOT NULL DEFAULT 0`);
        break;
      case 'mssql':
        this.statements.push(`${column} BIT NOT NULL DEFAULT 0`);
        break;
      default:
  ...
  timestamp(name: string): this {
    ...
    switch (this.grammar.driver) {
      ...
      case 'oracle':
        ...
        break;
      case 'mssql':
        this.statements.push(`${column} DATETIME2 NOT NULL`);
        break;
      default:
        this.statements.push(`${column} TEXT NOT NULL`);
        break;
